...
$result = $conexion->query("SELECT a.id_prod, (SELECT b.descripcion WHERE a.id_prod = b.id) FROM combo a, productos b WHERE a.id_combo = ".$id." AND a.id_prod = b.id AND a.estado = 1");
