...
if(isset($_GET["term"]))
{
    ...
    $result = $conexion->query("SELECT CA, CI, nombre, apellidos, telefono, lugar, correo, nivel FROM clientes WHERE estado = 1 AND nivel = 'lider' AND CONCAT(CA,' ',nombre,' ',apellidos) LIKE '%".$_GET["term"]."%' ORDER BY CA ASC");
