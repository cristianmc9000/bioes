...
if(isset($_GET["term"])) {
    ...
    $result = $conexion->query("SELECT * FROM clientes WHERE estado = 1 AND nivel = 'experta' AND lider = ".$ca." AND CONCAT(CA,' ',nombre,' ',apellidos) LIKE '%".$_GET["term"]."%' ORDER BY CA ASC");
